          ...
          <div>
              <div class="max-w-7xl mx-auto px-9 sm:px-6 lg:px-8">
                <div class="max-w-2xl mx-auto lg:max-w-none">
                  <div class="grid space-y-0 gap-x-6 gap-y-6 sm:grid-cols-2 lg:grid-cols-4">
                    <div class="group relative bg-black">
                      <div class="relative w-auto h-auto bg-white overflow-hidden group-hover:opacity-20 sm:aspect-w-2 sm:aspect-h-1 sm:h-64 lg:aspect-w-1 lg:aspect-h-1">
